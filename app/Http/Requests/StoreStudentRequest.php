...
class StoreStudentRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'cin_photo'=>'required|image|mimes:jpeg,png,jpg,gif|max:2048',
    ...
    public function attributes(): array
    {
        return [
            ...
            'cin_photo' => 'photo de la carte d\'identité',
            'card_photo' => 'photo de la carte scolaire',
     ...
     public function messages(): array
     {
         return [
             ...
             'cin_photo.required' => 'La photo de la carte d\'identité est obligatoire.',
             'cin_photo.image' => 'La photo de la carte d\'identité doit être une image.',
             'cin_photo.mimes' => 'La photo de la carte d\'identité doit être au format jpeg, png, jpg ou gif.',
             'cin_photo.max' => 'La photo de la carte d\'identité ne doit pas dépasser 2 Mo.',
             'card_photo.required' => 'La photo de la carte scolaire est obligatoire.',
             'card_photo.image' => 'La photo de la carte scolaire doit être une image.',
             'card_photo.mimes' => 'La photo de la carte scolaire doit être au format jpeg, png, jpg ou gif.',
             'card_photo.max' => 'La photo de la carte scolaire ne doit pas dépasser 2 Mo.',
             'classe_id.required' => 'La classe est obligatoire.',
             'relationship.required' => 'Le lien de parenté est obligatoire.',
             'guardian_phone_number.required' => 'Le numéro du responsable obligatoire.',
