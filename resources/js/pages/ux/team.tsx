...
export default function TeamPage() {
    const teamMembers = [
        ...
        },
        {
            ...
            email: 's.bernard@lycee-saintexupery.fr',
        },
        {
            name: 'Philippe Petit',
            ...
            email: 'p.petit@lycee-saintexupery.fr',
        },
        {
            name: 'Isabelle Moreau',
            role: 'Responsable des études littéraires',
            image: '/team/literature-head.jpg',
        ...
        },
        {
            ...
            image: '/team/guidance-counselor.jpg',
