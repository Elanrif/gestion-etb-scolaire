            ...
            <div className="bg-white">
                ...
                <section className="relative w-full overflow-hidden py-20 md:py-28">
                    <div className="absolute inset-0 z-0">
                        <img src="/history-hero.jpg" alt="Histoire du lycée" className="h-full w-full object-cover" />
                    ...
                    <div className="container px-4 md:px-6">
                        <div className="grid items-center gap-12 md:grid-cols-2">
                            ...
                            <div className="relative">
                                <img src="/history-image.jpg" alt="Photo historique du lycée" className="rounded-lg shadow-xl" />
                        ...
                        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                            <div className="rounded-xl bg-white p-6 shadow-md">
                                ...
                                <div className="flex items-center gap-4">
                                    <img src="/testimonials/alumni-1.jpg" alt="Ancien élève" className="h-12 w-12 rounded-full object-cover" />
                                    <div>
                            ...
                            <div className="rounded-xl bg-white p-6 shadow-md">
                                ...
                                <div className="flex items-center gap-4">
                                    <img src="/testimonials/teacher-1.jpg" alt="Ancien professeur" className="h-12 w-12 rounded-full object-cover" />
                                    <div>
                            ...
                            <div className="rounded-xl bg-white p-6 shadow-md">
                                ...
                                <div className="flex items-center gap-4">
                                    <img src="/testimonials/alumni-2.jpg" alt="Ancien élève" className="h-12 w-12 rounded-full object-cover" />
                                    <div>
