        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall title="Mettre à jour le mot de passe" description="Assurez-vous que votre compte utilise un mot de passe long et
                    ...
                    <form onSubmit={updatePassword} className="space-y-6">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Transition
                                ...
                                leaveTo="opacity-0"
                            >
                                <p className="text-sm text-neutral-600">Sauvergardé</p>
                            </Transition>
                        </div>
                    </form>
                </div>
