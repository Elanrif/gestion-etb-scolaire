        ...
        <AppHomeLayout>
            <div className="bg-white container mx-auto">
                ...
                <section className="relative w-full overflow-hidden py-20 md:py-28">
                    ...
                    <img src="/images/contact.jpg" alt="Contact" className="w-full object-cover aspect-[16/9]" />
                        <div className="absolute inset-0 bg-black/70" />
                    </div>
                    <div className="relative z-10 container px-4 md:px-6">
                        <div className="mx-auto max-w-3xl text-center">
                            <div className='flex justify-center mb-5 gap-3 items-center²'> 
                                <PhoneCall size={60} className='font-bold text-white'/>
                                <h1 className="text-4xl font-bold text-white sm:text-5xl md:text-6xl">Contactez-nous</h1>
                            </div>
