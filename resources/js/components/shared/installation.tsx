    ...
    const facilities = [
        {
            ...
            image: '/images/installation/salle.jpg',
        },
        {
        ...
        },
        {
            ...
            image: '/images/installation/sport.jpg',
        },
        {
            ...
            image: '/images/installation/resto.jpg',
        },
        {
            ...
            image: '/images/installation/labo.jpg',
        },
        {
            ...
            image: '/images/installation/art.jpg',
        },
        {
            ...
            image: '/images/installation/numerique.jpg',
        },
    ];
            ...
            <div className="bg-white">
                ...
                <section className="relative w-full overflow-hidden py-20 md:py-28">
                    <div className="absolute inset-0 z-0">
                        <img src="/images/installation/environnement.jpg" alt="Installations du lycée" className="h-full w-full object-cover" />
