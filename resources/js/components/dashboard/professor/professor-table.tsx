import { Professor } from '@/pages/dashboard/professor/professor-page';
...
const ProfessorTable: React.FC<ProfessorTableProps> = ({ professors, onViewProfessor, onEditProfessor, onDeleteProfessor, onAddProfessor }) => {
